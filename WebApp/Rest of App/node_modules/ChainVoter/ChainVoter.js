...
class Block{
	constructor(fromVoterID, fromName, fromAadhaar, toParty, constituency, publicKey,previousHash='0'){
...
class Blockchain{
	...
	addBlock(newBlock){
		...
		if(newBlock.fromAadhaar == null || newBlock.fromName == null || newBlock.fromVoterID ==null || newBlock.toParty == null || newBlock.constituency == null){
			alert("All fields must be filled!")
			throw new Error("All fields must be filled!")
		}

		if(this.checkBlock(newBlock)){
			alert("Only one vote allowed per voter!")
